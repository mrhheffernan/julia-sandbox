...
function integrate_quadrant(
    n_samples::Int,
    radius::Float32,
)::Tuple{Float64,Matrix{Float64},Matrix{Float64},Matrix{Float64}}
    """
    ...
    samples,
    reduce(vcat, transpose.(samples_inside)),
    reduce(vcat, transpose.(samples_outside))
end
